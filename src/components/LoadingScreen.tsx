...
export const LoadingScreen: React.FC<LoadingScreenProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    const steps = [
      { at: 25, text: 'تهيئة قاعدة البيانات المحلية وتأمين جلسة العمل...' },
      { at: 50, text: 'تجهيز بيانات اللاعبين والاشتراكات والمجموعات محليًا...' },
      { at: 75, text: 'تجهيز المعاملات المالية والمصروفات...' },
      { at: 95, text: 'تجهيز مؤشرات الأداء والتقارير الإدارية محليًا...' },
